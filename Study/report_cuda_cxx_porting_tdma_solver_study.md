...
- CUDA C++ profile example: `Study/example_cuda_cxx_profile.cu`
- Fortran profile example: `Study/example_fortran_profile.f90`
- Study runner: `Study/run_study_sweep.sh`
- Analysis script: `Study/result/analyze_study_results.py`
- Merged timing data: `Study/result/tdma_total_profile_merged_260702_merged.csv`
- Merged correctness data: `Study/result/tdma_correctness_merged_260702_merged.csv`
- Merged case manifest: `Study/result/tdma_case_manifest_merged_260702_merged.csv`
- Representative environment capture: `Study/result/tdma_environment_260702_175504.txt`
